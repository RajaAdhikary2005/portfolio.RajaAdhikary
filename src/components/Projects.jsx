const projects = [
    {
        ...
        tech: ["REACT", "TAILWIND"],
        link: "mriganka-guha-portfolio.vercel.app"
    },
    {
                        ...
                        {projects.map((project, idx) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <a href={project.link} className="inline-block px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 text-white font-semibold shadow-lg hover:scale-105 transition-all duration-200">
                                        View Project →
                                    </a>
                                </div>
                            </div>
